...
export async function importWallet(
  ...
  console.log(
    `Importing wallet with minimum ETH balance: ${minEthBalance}, minimum USDC balance: ${minUsdcBalance}`,
  );
  ...
  try {
    ...
    console.log(
      `Parsed wallet data. Found ${Object.keys(seedData).length} wallet(s)`,
    );
